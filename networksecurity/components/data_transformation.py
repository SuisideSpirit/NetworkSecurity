...
from networksecurity.utils.utils import save_numpy_array , save_obj
...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        logging.info("Entered get_data_tranformer_object method of transformer class ")
        try :
            imputer = KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS)
            logging.info("KNN impuer initialised")
    ...
    def initiate_data_tranformation(self)->DataTransformationArtifact:
        ...
        try:
            logging.info("started transformation")
            ...
            save_obj(self.data_transformation_config.transformed_object_file_path , obj= preprocessor_object)
