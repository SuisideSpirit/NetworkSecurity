...
import pandas as pd
import os,sys
from networksecurity.utils.utils import save_obj
from networksecurity.utils.utils import load_numpy_array_data , load_object
    ...
    def track_mlflow(self, best_model, 
        ...
        try:
            ...
            with mlflow.start_run():
                # log train metrics
                mlflow.log_metric("train_f1_score",
